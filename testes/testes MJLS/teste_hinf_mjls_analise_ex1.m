...
fprintf(' Iniciando Teste de Análise Hinf para MJLS Incerto - Exemplo 1 \n');
...
for deg = graus_P_teste
    for idx = 1:length(graus_rho_teste)
        ...
        out =  hinf_lmi_mjls_d_incerto_analise(A, E, C, Ez, Gamma, mu, opt);
...
%     writetable(T_H, 'teste_controle_H2_MJLS_Ex1_N2_Tabela.csv'); 
