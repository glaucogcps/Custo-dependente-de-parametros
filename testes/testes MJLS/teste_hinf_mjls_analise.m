...
if N == 2
    ...
    hold on; grid on;
    title('Análise H_\infty MJLS: Variação do grau de \rho(\alpha)'); 
...
graus_P_teste = 1:4;   % Testando graus de 1 a 4 para a matriz de Lyapunov P
...
for deg = graus_P_teste
    for idx = 1:length(graus_rho_teste)
        ...
        out = hinf_lmi_mjls_d_incerto_analise(A, E, Cz, Ez, Gamma, mu, opt);
...
if isempty(H_table)
    ...
    writetable(T_H, 'teste_analise_Hinf_MJLS_Ex2_Tabela.csv');
%     writetable(T_H, 'teste_analise_Hinf_MJLS_Ex2_N2_Tabela.csv');
    fprintf('Tabela salva como teste_analise_Hinf_MJLS_Ex2_Tabela.csv\n');
end

if N == 2 && ~isempty(H_table)
    print('teste_analise_Hinf_MJLS_Ex2_grafico', '-depsc'); 
    savefig('teste_analise_Hinf_MJLS_Ex2_grafico.fig');
%     print('teste_analise_Hinf_MJLS_Ex2_N2_grafico', '-depsc'); 
%     savefig('teste_analise_Hinf_MJLS_Ex2_N2_grafico.fig');
    fprintf('Gráfico salvo como teste_analise_Hinf_MJLS_Ex2_grafico.eps e teste_analise_Hinf_MJLS_Ex2_grafico.fig\n');
end
