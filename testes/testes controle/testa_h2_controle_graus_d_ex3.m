...
fprintf(' Iniciando Teste de Síntese de Controle H2 - Exemplo 3 \n');
...
if N == 2 && ~isempty(H_table) 
    print('teste_controle_H2_Ex3_N2_grafico', '-depsc');
    savefig('teste_controle_H2_Ex3_N2_grafico.fig');
    fprintf('Gráfico salvo como teste_controle_H2_Ex3_grafico.eps e teste_controle_H2_Ex3_grafico.fig\n');
elseif N ~= 2
